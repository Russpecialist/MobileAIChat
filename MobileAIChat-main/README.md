...
4. Запустите приложение (`flutter run -d ios` для iOS Simulator или через Android Studio/Xcode)
5. Введите API ключ в самом приложении при первом запуске
6. Следуйте инструкциям в [INSTALL.md](INSTALL.md) для детального запуска и тестирования
